...
<ui:composition template="/template/template-facelets.xhtml">
    <ui:define name="title"><img src="/images/charity-128.png" alt="" border="0" width="128" height="128" align="right"/>Make (Real) Change<br/><font class="mediumfont">Make great content and great contributions -- at the same time!</font><br/><br/></ui:define>
    <ui:param name="navtab" value="home"/>
    <ui:define name="body">
    <d:authorization acl="public" redirectonfail="true"/>
        <h:form>
            <t:saveState id="save" value="#{publicCharity}"/>
            <br/><br/><br/><br/>
