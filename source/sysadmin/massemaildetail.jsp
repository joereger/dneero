...
<%@ page import="com.dneero.htmluibeans.SysadminMassemailDetail" %>
...
<%
    if (request.getParameter("action") != null) {
        try {
            ...
            sysadminMassemailDetail.getMassemail().setIssenttobloggers(CheckboxBoolean.getValueFromRequest("issenttobloggers"));
            sysadminMassemailDetail.getMassemail().setIssenttoresearchers(CheckboxBoolean.getValueFromRequest("issenttoresearchers"));
            sysadminMassemailDetail.getMassemail().setIssenttouserswhooptoutofnoncriticalemails(CheckboxBoolean.getValueFromRequest("issenttouserswhooptoutofnoncriticalemails"));
    ...
    <div class="panel" id="panel1" style="display: block">
        ...
        <form action="massemaildetail.jsp" method="post">
            ...
            <table cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td valign="top">
                        <font class="formfieldnamefont">Send to Bloggers?</font>
                    </td>
                    <td valign="top">
                        <%=CheckboxBoolean.getHtml("issenttobloggers", sysadminMassemailDetail.getMassemail().getIssenttobloggers(), "", "")%>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        <font class="formfieldnamefont">Send to Researchers?</font>
                    </td>
                    <td valign="top">
                        <%=CheckboxBoolean.getHtml("issenttoresearchers", sysadminMassemailDetail.getMassemail().getIssenttoresearchers(), "", "")%>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        <font class="formfieldnamefont">(Dangerous!)Send to Users who opted out of non-critical email?</font>
                    </td>
                    <td valign="top">
                        <%=CheckboxBoolean.getHtml("issenttouserswhooptoutofnoncriticalemails", sysadminMassemailDetail.getMassemail().getIssenttouserswhooptoutofnoncriticalemails(), "", "")%>
                    </td>
                </tr>
             </table>
