...
<%@ include file="/template/header.jsp" %>
    ...
    <!-- Start FAQ Question -->
    <font class="mediumfont" color="#333333">Does this site pay based on friends that my friends invite?</font>
    <br/>
    <font class="smallfont">
    ...
    <br/><br/>
    We do not charge you to take part in the program.  Pyramid schemes often include a hefty up-front charge with the promise of exponential growth from downstream users.
    <br/><br/>
    We do not pay you simply to recruit friends... we pay you a share of our revenue that is generated by your friends.
    <br/><br/>
    ...
    <br/><br/>
    Nobody is ever paying any money for an item of fictional value, as in pyramid schemes where items with little actual value are paid for.  The system works on the other side of the equation... when we pay you.  There's no "entry price."
    </font>
    <br/><br/><br/>
    <!-- End FAQ Question -->

    <!-- Start FAQ Question -->
    <font class="mediumfont" color="#333333">And I get paid for my friends' activity forever?</font>
    <br/>
    <font class="smallfont">
    ...
    <!-- Start FAQ Question -->
    <font class="mediumfont" color="#333333">Do I get paid for my friends' conversations and impressions?</font>
    <br/>
    <font class="smallfont">
    All of it.
    </font>
    ...
    <br/>
    <font class="smallfont">
    You get paid until you reach the limit set by the conversation creator (shown when you decide whether to join the conversation).  Or until 30 days have elapsed since the end of the conversation (also listed on the conversation).
    </font>
    <br/><br/><br/>
    <!-- End FAQ Question -->
