...
<h:form>
    <t:dataTable id="usertable"
        ...
        <t:column>
            ...
            <%--
            <t:commandLink action="#{BloggerOfferDetail.beginView}">
                <h:outputText value="View" />
                <f:param name="offerid" value="#{offer.offerid}"></f:param>
                <t:updateActionListener property="#{BloggerOfferDetail.offer.offerid}" value="#{offer.offerid}" />
            </t:commandLink>
            --%>
            <h:commandLink action="#{BloggerOfferDetail.beginView}">
                <h:outputText value="View" escape="false" />
                <f:param name="offerid" value="#{offer.offerid}" />
            </h:commandLink>
        </t:column>
    </t:dataTable>
