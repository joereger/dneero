...
<%String jspPageName="/blogger/bloggerearningsrevshare.jsp";%>
...
<%@ include file="/template/header.jsp" %>
        ...
        <table cellpadding="0" cellspacing="0" border="0">
            ...
            <div style="background: #ffffff; width: 350px; padding: 20px;">
               ...
               <br/>
               <font class="smallfont">We'll pay you a piece of any earnings generated by friends that you invite to the program... out of our own pocket.  When one of your friends accepts the invitation you'll see them listed to the right... and then you'll be making even more money!</font>
               <br/>
               <br/>
