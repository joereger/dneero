...
<%@ include file="/template/header.jsp" %>
    ...
    This page lists blog displays/impressions of a <%=Pagez._survey()%>.  Note that in the calculation of earnings some impressions may not be included because the researcher can set a maximum number of paid blog displays per blog.
    <br/><br/><br/>
    </font></div></center>
