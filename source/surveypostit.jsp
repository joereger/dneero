...
<%@ include file="/template/header.jsp" %>
    ...
    <%
    if (1==1){
        String templateHomepageName = "surveypostit.vm-"+Pagez.getUserSession().getPl().getPlid();
        String templateHomepage = PlTemplate.getFileFromPlTemplateDir(Pagez.getUserSession().getPl(), "surveypostit.vm");
        VelocityContext velocityContext = new VelocityContext();
        velocityContext.put("pagetitle", pagetitle);
        velocityContext.put("navtab", navtab);
        velocityContext.put("acl", acl);
        velocityContext.put("publicSurveyPostit", publicSurveyPostit);
        ...
        velocityContext.put("cleanForHtmlTitle", Str.cleanForHtml(publicSurveyPostit.getSurvey().getTitle()));
        velocityContext.put("cleanForHtmlDescription", Str.cleanForHtml(publicSurveyPostit.getSurvey().getDescription()));
        ...
        <%--<% if (!Pagez.getUserSession().getIsfacebookui()){ %>--%>
            ...
            <%--<tr>--%>
                <%--<td valign="top" width="35%">--%>
                    <%--&lt;%&ndash;<div class="rounded" style="background: #e6e6e6;">&ndash;%&gt;--%>
                        <%--<div class="rounded" style="background: #ffffff; text-align: center;">--%>
                            <%--<font class="mediumfont">You've Entered this <%=Pagez._Survey()%>.</font>--%>
                            <%--&lt;%&ndash;<br/>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<img src="/images/ok-128.png" width="128" height="128"/>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<br/>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<font class="smallfont">Now share your response to get others involved!</font>&ndash;%&gt;--%>
                        <%--</div>--%>
                        <%--<br/>--%>
