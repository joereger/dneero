...
public class Balancetransaction extends BasePersistentClass implements java.io.Serializable, RegerEntity, AuthControlled {
    ...
    public static Balancetransaction get(int id) {
        Logger logger = Logger.getLogger("com.dneero.dao.Balancetransaction");
        try {
            ...
            logger.error("com.dneero.dao.Balancetransaction", ex);
            return new Balancetransaction();
        }
    }
