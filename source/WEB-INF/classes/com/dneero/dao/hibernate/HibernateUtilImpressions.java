        ...
        if (ApplicationStartup.getIswabapprooddirdiscovered()){
            if (Db.getHaveValidConfig()){
                try {
                    ...
                    if (InstanceProperties.getInfinispanconfigfilehibernateimpressions()!=null && !InstanceProperties.getInfinispanconfigfilehibernateimpressions().equals("")){
                        conf.setProperty("hibernate.cache.infinispan.cfg", InstanceProperties.getInfinispanconfigfilehibernateimpressions());
                    } else {
                        conf.setProperty("hibernate.cache.infinispan.cfg", "infinispan-cache4hibernate-impressions.xml");
                    }
                    ...
                    //String ehcacheHibernateConfigFile = "/ehcache-hibernate-impressions.xml";
