...
public class Dbcache extends BasePersistentClassDbcache implements java.io.Serializable, AuthControlled {
    ...
    public static Dbcache get(int id) {
        ...
        try {
            ...
            Dbcache obj = (Dbcache) HibernateUtilDbcache.getSession().get(Dbcache.class, id);
            if (obj == null) {
