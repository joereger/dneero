 ...
 * Time: 11:57:46 AM
 */
public class Version35 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(DbConfig dbConfig){
        ...
        //-----------------------------------
        //-----------------------------------
        int countdds = Db.RunSQLUpdate("UPDATE survey SET dneeromarkuppercent='"+ SurveyMoneyStatus.DEFAULTDNEEROMARKUPPERCENT+"'", dbConfig);
        //-----------------------------------
        //-----------------------------------
