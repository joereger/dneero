...
public class Version40 implements UpgradeDatabaseOneVersion {
    ...
    public void doPreHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("ALTER TABLE surveydiscuss DROP isapproved");
        //-----------------------------------
        //-----------------------------------
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int countdds = Db.RunSQLUpdate("UPDATE surveydiscuss SET isresearcherreviewed=true");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countddds = Db.RunSQLUpdate("UPDATE surveydiscuss SET issysadminreviewed=true");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countddsss = Db.RunSQLUpdate("UPDATE surveydiscuss SET isresearcherrejected=true");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countddddds = Db.RunSQLUpdate("UPDATE surveydiscuss SET issysadminrejected=true");
        //-----------------------------------
        //-----------------------------------
