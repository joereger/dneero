 ...
 * Time: 11:57:46 AM
 */
public class Version67 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(DbConfig dbConfig){
        ...
        //-----------------------------------
        //-----------------------------------
        int countdddss = Db.RunSQLUpdate("UPDATE survey SET embedversion='"+ Survey.EMBEDVERSION_01 +"'", dbConfig);
        //-----------------------------------
        //-----------------------------------
