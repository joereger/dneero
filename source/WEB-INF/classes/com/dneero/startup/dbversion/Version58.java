 ...
 * Time: 11:57:46 AM
 */
public class Version58 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(DbConfig dbConfig){
        ...
        //-----------------------------------
        //-----------------------------------
        int countddds = Db.RunSQLUpdate("DROP TABLE supportissue", dbConfig);
        //-----------------------------------
        //-----------------------------------
        ...
        //-----------------------------------
        //-----------------------------------
        int countdddsg = Db.RunSQLUpdate("DROP TABLE supportissuecomm", dbConfig);
        //-----------------------------------
        //-----------------------------------
