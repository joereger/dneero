...
public class Version15 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("UPDATE survey SET publicsurveydisplays='0'");
        //-----------------------------------
        //-----------------------------------
        
        //-----------------------------------
        //-----------------------------------
        int count1 = Db.RunSQLUpdate("ALTER TABLE survey DROP displayspublicsurveytake");
        //-----------------------------------
        //-----------------------------------
        ...
        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("ALTER TABLE survey DROP displayspublicsurveydetail");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count3 = Db.RunSQLUpdate("ALTER TABLE survey DROP displaysbloggerdetail");
        //-----------------------------------
        //-----------------------------------
