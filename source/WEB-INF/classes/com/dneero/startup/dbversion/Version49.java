 ...
 * Time: 11:57:46 AM
 */
public class Version49 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(DbConfig dbConfig){
        ...
        if (1==1){
            //-----------------------------------
            //-----------------------------------
            int count = Db.RunSQLUpdate("ALTER TABLE impression DROP impressionspaid", DbFactory.getDefaultDbConfigForImpressions());
            //-----------------------------------
            //-----------------------------------
        }
        ...
        if (1==1){
            //-----------------------------------
            //-----------------------------------
            int count = Db.RunSQLUpdate("ALTER TABLE impression DROP impressionstobepaid", DbFactory.getDefaultDbConfigForImpressions());
            //-----------------------------------
            //-----------------------------------
        }
        ...
        if (1==1){
            //-----------------------------------
            //-----------------------------------
            int count = Db.RunSQLUpdate("ALTER TABLE impression DROP impressionsbyday", DbFactory.getDefaultDbConfigForImpressions());
            //-----------------------------------
            //-----------------------------------
        }
        ...
        if (1==1){
            //-----------------------------------
            //-----------------------------------
            int count = Db.RunSQLUpdate("ALTER TABLE response DROP isdatamigrated", DbFactory.getDefaultDbConfig());
            //-----------------------------------
            //-----------------------------------
        }
