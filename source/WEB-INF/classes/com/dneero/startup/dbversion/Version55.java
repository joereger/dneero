 ...
 * Time: 11:57:46 AM
 */
public class Version55 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(DbConfig dbConfig){
        ...
        //-----------------------------------
        //-----------------------------------
        int count2w = Db.RunSQLUpdate("UPDATE panel SET description=''", dbConfig);
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("UPDATE panel SET issystempanel=false", dbConfig);
        //-----------------------------------
        //-----------------------------------
