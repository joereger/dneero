...
public class Version34 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int countdds = Db.RunSQLUpdate("UPDATE survey SET charityonlyallowcustom=false");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countddsd = Db.RunSQLUpdate("UPDATE survey SET charitycustom=''");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countdddsd = Db.RunSQLUpdate("UPDATE survey SET charitycustomurl=''");
        //-----------------------------------
        //-----------------------------------
