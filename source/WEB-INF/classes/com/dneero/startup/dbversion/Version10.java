...
public class Version10 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("UPDATE user SET allownoncriticalemails=true");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("UPDATE massemail SET issenttouserswhooptoutofnoncriticalemails=true");
        //-----------------------------------
        //-----------------------------------
