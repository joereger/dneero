...
public class Version9 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("ALTER TABLE blogger DROP notifyofnewsurveysbyemail");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("ALTER TABLE blogger DROP lastnewsurveynotificationsenton");
        //-----------------------------------
        //-----------------------------------
