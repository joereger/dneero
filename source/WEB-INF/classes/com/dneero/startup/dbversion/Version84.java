 ...
 * Time: 11:57:46 AM
 */
public class Version84 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(DbConfig dbConfig){
        ...
        //-----------------------------------
        //-----------------------------------
        int count1 = Db.RunSQLUpdate("UPDATE pl SET surveycalled=''", dbConfig);
        //-----------------------------------
        //-----------------------------------
        ...
        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("UPDATE pl SET surveycalledplural=''", dbConfig);
        //-----------------------------------
        //-----------------------------------
