 ...
 * Time: 11:57:46 AM
 */
public class Version32 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(DbConfig dbConfig){
        ...
        //-----------------------------------
        //-----------------------------------
        int countdds = Db.RunSQLUpdate("UPDATE survey SET isaccesscodeonly=false", dbConfig);
        //-----------------------------------
        //-----------------------------------
        ...
        //-----------------------------------
        //-----------------------------------
        int countddds = Db.RunSQLUpdate("UPDATE survey SET accesscode=''", dbConfig);
        //-----------------------------------
        //-----------------------------------
