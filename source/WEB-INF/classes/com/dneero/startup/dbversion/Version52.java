 ...
 * Time: 11:57:46 AM
 */
public class Version52 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(DbConfig dbConfig){
        ...
        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("UPDATE user SET lastlogindate='"+Time.dateformatfordb(Time.xYearsAgoStart(Calendar.getInstance(), 2))+"'", dbConfig);
        //-----------------------------------
        //-----------------------------------
