    ...
    public Object get(String beanname){
        ...
        if (beans!=null && beans.containsKey(beanname)){
            ...
            try{
                ...
                Class clazz = Class.forName("com.dneero.htmluibeans."+ beanname);
...
//                    if (anInterface.getName().equals("com.dneero.htmlui.HtmlUiBean")){
//                        logger.debug("implements com.dneero.htmlui.HtmlUiBean");
//                        implementsHtmlUiBean = true;
//                    } else {
//                        logger.debug("doesn't implement com.dneero.htmlui.HtmlUiBean");
//                    }
//                }
