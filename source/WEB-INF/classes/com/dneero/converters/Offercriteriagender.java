 ...
 * Time: 11:09:14 AM
 */
public class Offercriteriagender implements javax.faces.convert.Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String string) throws ConverterException {
        Set<com.dneero.dao.Offercriteriagender> ocg = new HashSet<com.dneero.dao.Offercriteriagender>();
