    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        for (Iterator<Researcher> iterator = researchers.iterator(); iterator.hasNext();) {
            ...
            if (amt>0){
                ...
                MoveMoneyInAccountBalance.charge(User.get(researcher.getUserid()), invoice.getAmttotal(), "Activity for: "+Time.dateformatfordb(Time.getCalFromDate(invoice.getStartdate()))+" to "+Time.dateformatfordb(Time.getCalFromDate(invoice.getEnddate())), 0, invoice.getInvoiceid());
