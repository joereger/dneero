            ...
            <tr>
                <td valign="top">
                    ...
                    <center><div class="rounded" style="background: #F2FFBF; text-align: left; padding: 20px;"><font class="smallfont">
                        ...
                        <br/>
                        Use this screen to look at a subset of the <a href="/researcher/results_answers.jsp?surveyid=<%=researcherResultsAnswersAdvanced.getSurvey().getSurveyid()%>">overall results</a>.  Choose only the criteria for respondents that you want to see and then click Show Results.  You can optionally name and save your filter for easy access later on.  Saved filters can be applied to other surveys too.
                    </font></div></center>
                ...
                <td valign="top" width="33%">
                    <div class="rounded" style="background: #e6e6e6; text-align: left; padding: 20px;">
                        ...
                        <%} else {%>
                            ...
                            <br/>
                            <font class="tinyfont">Choose a filter to see the results from this survey filtered through it.</font>
                            </form>
                        <%}%>
                    </div>
                </td>
