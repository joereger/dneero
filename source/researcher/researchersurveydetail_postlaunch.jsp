...
if (researcherSurveyDetailPostlaunch.getSurvey().getStatus()==Survey.STATUS_OPEN){
    Pagez.getUserSession().setMessage("Your conversation is launched!  Why not be the first to join?");
...
<%@ include file="/template/header.jsp" %>
    ...
    <font class="pagetitlefont" style="color: #333333;">Congratulations!  Your conversation has been launched!</font>
    <br/><br/>
