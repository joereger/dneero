            ...
            <td valign="top" width="33%">
                ...
                <div class="rounded" style="padding: 15px; margin: 5px; background: #e6e6e6;">
                    ...
                    <font class="smallfont">
                        ...
                        <br/><br/>You can use Rankings to measure across many <%=Pagez._surveys()%>.  In this way you get a sense of how a person responds over time to many different things.
                        <br/><br/>As people score points you can skim those in the top 10% of Ranking score and put them into a Panel which allows you to create <%=Pagez._surveys()%> that only they can see and take.  In this way you're not only targeting but engaging your audience.
                    </font>
                </div>
            </td>
        </tr>
