        ...
        try {
            if (researcherSurveyDetail06.getSurvey().getStatus()>Survey.STATUS_DRAFT){
                if (request.getParameter("action").equals("previous")){
                        Pagez.sendRedirect("/researcher/researchersurveydetail_05.jsp?surveyid="+researcherSurveyDetail06.getSurvey().getSurveyid()+"&ispreviousclick=1");
                        return;
                } else {
...
<form action="/researcher/researchersurveydetail_06.jsp" method="post"  class="niceform" id="rsdform">
                    ...
                    <td valign="top" width="35%">
                        ...
                        <div class="rounded" style="background: #e6e6e6; text-align: left; padding: 20px;">
                            ...
                            <div class="rounded" style="background: #ffffff; text-align: left; padding: 20px;">
                                ...
                                <br/>
                                <input type="submit" class="formsubmitbutton sexybutton sexysimple sexyxxl" value="Apply Coupon" onclick="document.getElementById('action').value='applycoupon';" style="font-size: 10px;">
                                </center>
                            </div>
                        </div>
                    </td>
