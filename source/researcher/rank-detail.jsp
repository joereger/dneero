...
<%String jspPageName="/researcher/rank-detail.jsp";%>
                    ...
                    for (Iterator<Question> iterator = researcherRankDetail.getQuestions().iterator(); iterator.hasNext();){
                        ...
                        <tr>
                            <td valign="top">
                                ...
                                <br/><img src="/images/clear.gif" alt="" width="25" height="1"><font class="tinyfont">From <%=Pagez._survey()%>: <a href="/researcher/rank-addquestion.jsp?rankid=<%=researcherRankDetail.getRank().getRankid()%>&surveyid=<%=survey.getSurveyid()%>"><%=survey.getTitle()%></a></font>
                                <%
