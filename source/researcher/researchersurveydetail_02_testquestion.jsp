...
<%@ include file="/template/header.jsp" %>
    ...
    <div id="togglehelp">
        ...
        <b>A Qualifying Question is a unique type of question that the <%=Pagez._survey()%> participant must answer correctly to qualify to join in.</b>  This may come in handy in the following scenarios:
        <ul>
            <li><b>You want people to visit your site</b> before joining the <%=Pagez._survey()%>.  Include a link to your site in your <%=Pagez._survey()%> and then use a Test Question to ask them something like 'On our homepage what color is the button on the far right'.  If they answer 'blue' then they can join in.</li>
        ...
        <br/><br/>
        <b>If a <%=Pagez._survey()%> participant can't answer your question correctly they'll be told that they can't join the <%=Pagez._survey()%>.</b>  Note that this test question will not be included in the <%=Pagez._survey()%> results or in the widget that people embed into their blogs/social networks.
        </font></div>
    </div>
