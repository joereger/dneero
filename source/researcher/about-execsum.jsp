...
String pagetitle = "Overview of Conversation Creation";
...
<table cellpadding="10" cellspacing="2" border="0" width="100%">
    <tr>
        <td valign="top">
            ...
            <li><b><%=Pagez.getUserSession().getPl().getNameforui()%> will publicize your conversation</b> and find bloggers who want to respond to it. You'll pay for only those responses and conversation displays that happen.</li>
            <li><b><%=Pagez.getUserSession().getPl().getNameforui()%> tracks conversation responses and blog impressions</b>, providing you with simple billing and results data</li>
            </ol>
            <br/>
            ...
            <br/>
            Other tools like Umbria and BuzzMetrics are great at finding out what people are saying about your product.  But this approach makes it difficult to see how people feel about something in particular.  Often you need to drill down or focus on a specific point.  With <%=Pagez.getUserSession().getPl().getNameforui()%> you're able to frame the conversation with questions.  This gets a base set of feedback from all social people who respond to it.
            <br/><br/><br/>
