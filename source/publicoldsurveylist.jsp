...
<%@ include file="/template/header.jsp" %>
    ...
    <%} else {%>
        <%
            ...
            cols.add(new GridCol("Survey Name", "<a href=\"/surveyresults.jsp?surveyid=<$surveyid$>\"><$title$></a><br/><font class=\"tinyfont\"><$description$></font>", false, "", "normalfont", "", "font-weight: bold;"));
