           ...
           <td width="225">
               ...
               <div class="rounded" style="background: #e6e6e6; padding: 10px;">
                   ...
                   <div class="rounded" style="background: #ffffff; padding: 10px;">
                        <font class="tinyfont">You can choose to donate your earnings to charity with a single click!  And as a researcher you can ignite conversations that require people to donate.  We even give you the ability to add your own charity.<br/><a href="/charity.jsp">Learn more.</a></font><br/>
                   </div>
               </div>
