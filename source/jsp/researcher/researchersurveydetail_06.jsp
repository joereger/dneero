...
"        <h:outputText value=\"<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getTitle()%>\" styleClass=\"pagetitlefont\" rendered=\"${researcherSurveyDetail06.title ne ''}\"/>\n" +
"        <br clear=\"all\"/>";
...
<%@ include file="/jsp/templates/header.jsp" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
        ...
        <td valign="top">
            <h:outputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getNumberofbloggersqualifiedforthissurvey()%>"></h:outputText>
        </td>
        <td valign="top">
        </td>
        ...
        <td valign="top">
            <h:outputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getNumberofquestions()%>"></h:outputText>
        </td>
        <td valign="top">
        </td>
        ...
        <td valign="top">
            <h:outputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getStartdate()%>"></h:outputText>
        </td>
        <td valign="top">
        </td>
        ...
        <td valign="top">
            <h:outputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getEnddate()%>"></h:outputText>
        </td>
        <td valign="top">
        </td>
        ...
        <td valign="top">
            <h:outputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getMaxrespondentpayments()%>"></h:outputText>
        </td>
        <td valign="top">
        </td>
        ...
        <td valign="top">
            <h:outputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getMaximpressionpayments()%>"></h:outputText>
        </td>
        <td valign="top">
        </td>
        ...
        <td valign="top">
            <h:outputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getHideresultsfee()%>"></h:outputText>
        </td>
        <td valign="top">
        </td>
        ...
        <td valign="top">
            <h:outputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getDneerofee()%>"></h:outputText>
        </td>
        <td valign="top">
        </td>
        ...
        <td valign="top">
            <h:outputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getMaxpossiblespend()%>"></h:outputText>
        </td>
        <td valign="top">
        </td>
    ...
    <d:roundedCornerBox uniqueboxname="warningtoomanyquestions" bodycolor="ffffcc" widthinpixels="700" rendered="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getWarningtoomanyquestions()%>">
        <h:graphicImage url="/images/lightbulb_on.png"></h:graphicImage>
        <font class="smallfont">
    ...
    <d:roundedCornerBox uniqueboxname="warningnoquestions" bodycolor="ffffcc" widthinpixels="700" rendered="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getWarningnoquestions()%>">
        <h:graphicImage url="/images/lightbulb_on.png"></h:graphicImage>
        <font class="smallfont">
    ...
    <d:roundedCornerBox uniqueboxname="warningtimeperiodtooshort" bodycolor="ffffcc" widthinpixels="700" rendered="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getWarningtimeperiodtooshort()%>">
        <h:graphicImage url="/images/lightbulb_on.png"></h:graphicImage>
        <font class="smallfont">
     ...
     <t:div rendered="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getWarningdonthaveccinfo()%>">
        <div class="rounded" style="background: #ffffff; text-align: left; padding: 20px;">
            ...
            <tr>
               ...
               <td valign="top" align="left">
                    <h:inputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getFirstname()%>" id="firstname"  size="15"></h:inputText>
                    <h:outputText value=" " styleClass="formfieldnamefont"></h:outputText>
                    <h:inputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getLastname()%>" id="lastname" size="15"></h:inputText>
            ...
            <tr>
               ...
               <td valign="top" align="left">
                    <h:inputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getStreet()%>" id="street" size="30"></h:inputText>
            ...
            <tr>
               ...
               <td valign="top" align="left">
                    <h:inputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getCccity()%>" id="cccity" size="20"></h:inputText>
                    <h:outputText value=" " styleClass="formfieldnamefont"></h:outputText>
                    <h:inputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getCcstate()%>" id="ccstate"  size="2"></h:inputText>
                    <h:outputText value=" " styleClass="formfieldnamefont"></h:outputText>
                    <h:inputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getPostalcode()%>" id="postalcode" size="6"></h:inputText>
            ...
            <tr>
               ...
               <td valign="top" align="left">
                    <h:selectOneMenu value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getCctype()%>" id="cctype" required="true">
                        <f:selectItems value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getCreditcardtypes()%>"/>
                    </h:selectOneMenu>
            ...
            <tr>
               ...
               <td valign="top" align="left">
                    <h:inputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getCcnum()%>" id="ccnum"  size="18">
            ...
            <tr>
               ...
               <td valign="top" align="left">
                    <h:selectOneMenu value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getCcexpmo()%>" id="ccexpmo" required="true">
                        <f:selectItems value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getMonthsForCreditcard()%>"/>
                    </h:selectOneMenu>
                    /
                    <h:selectOneMenu value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getCcexpyear()%>" id="ccexpyear" required="true">
                        <f:selectItems value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getYearsForCreditcard()%>"/>
                    </h:selectOneMenu>
            ...
            <tr>
               ...
               <td valign="top" align="left">
                    <h:inputText value="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getCvv2()%>" id="cvv2" size="3"></h:inputText>
    ...
    <font class="mediumfont">
        <ul>
            <li>I understand that by launching this survey I am committing to spending up to <%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getMaxpossiblespend()%> (Max Possible Spend.)</li>
            ...
            <li>I understand that my account balance must be sufficient to support activities:
                <ul>
                    <li>20% of the <%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getMaxpossiblespend()%> will be charged now.</li>
    ...
    <f:verbatim><br/><br/></f:verbatim>
    <div class="surveyeditbuttonbox"><div class="surveyeditpreviousbutton"><h:commandButton action="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getPreviousStep()%>" value="Previous Step" styleClass="formsubmitbutton"/></div><div class="surveyeditnextbutton"><h:commandButton action="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getSaveSurveyAsDraft()%>" value="Save and Continue Later" styleClass="formsubmitbutton" rendered="#{researcherSurveyDetail06.status eq 1}"/><h:commandButton action="<%=((ResearcherSurveyDetail06)Pagez.getBeanMgr().get("ResearcherSurveyDetail06")).getSaveSurvey()%>" value="Launch this Survey!" styleClass="formsubmitbutton" rendered="#{researcherSurveyDetail06.status eq 1}"/></div></div>
