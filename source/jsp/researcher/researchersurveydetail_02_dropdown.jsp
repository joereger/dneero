...
<%@ include file="/jsp/templates/header.jsp" %>
    ...
    <h:inputHidden name="questionid" value="<%=((ResearcherSurveyDetail02dropdown)Pagez.getBeanMgr().get("ResearcherSurveyDetail02dropdown")).getQuestionid()%>" />
    ...
    <table cellpadding="0" cellspacing="0" border="0">
        ...
        <td valign="top">
            <h:inputText value="<%=((ResearcherSurveyDetail02dropdown)Pagez.getBeanMgr().get("ResearcherSurveyDetail02dropdown")).getQuestion()%>" id="question" required="true">
        ...
        <td valign="top">
            <h:selectBooleanCheckbox value="<%=((ResearcherSurveyDetail02dropdown)Pagez.getBeanMgr().get("ResearcherSurveyDetail02dropdown")).getIsrequired()%>" id="isrequired" required="true"></h:selectBooleanCheckbox>
        </td>
        <td valign="top">
        ...
        <td valign="top">
            ...
            <h:inputTextarea value="<%=((ResearcherSurveyDetail02dropdown)Pagez.getBeanMgr().get("ResearcherSurveyDetail02dropdown")).getOptions()%>" id="options" required="true" cols="25" rows="10">
            </h:inputTextarea>
        </td>
        <td valign="top">
        ...
        <td valign="top">
            <h:commandButton action="<%=((ResearcherSurveyDetail02dropdown)Pagez.getBeanMgr().get("ResearcherSurveyDetail02dropdown")).getSaveQuestion()%>" value="Save Question and Continue" styleClass="formsubmitbutton"></h:commandButton>
