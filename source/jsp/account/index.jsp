                ...
                <td width="250" valign="top">
                    <div class="rounded" style="padding: 5px; margin: 5px; background: #e6e6e6;">
                        <div class="rounded" style="padding: 15px; margin: 5px; background: #ffffff;">
                            ...
                            <tr><td valign="top"></td><td valign="top">
                                ...
                                <br/><font class="largefont" style="color: #cccccc;">#{accountBalance.currentbalance}</font>
                                <c:if test="#{accountBalance.pendingearningsDbl gt 0}">
                                    <br/><font class="formfieldnamefont" style="color: #666666;">Pending: #{accountBalance.pendingearnings}</font>
                        ...
                        <div class="rounded" style="padding: 15px; margin: 5px; background: #e6e6e6;">
                            <table cellpadding="0" cellspacing="0" border="0"><tr><td valign="top"><img src="/images/wireless-green.png" alt="" border="0"/></td><td valign="top"><img src="/images/clear.gif" width="1" height="5"/><br/>
                                <h:commandLink value="Account Settings" action="#{accountSettings.beginView}" styleClass="mediumfont" style="color: #596697;"/>
                            </td></tr>
                            <tr><td valign="top"></td><td valign="top">
                            ...
                            <br/><br/>
                            <table cellpadding="0" cellspacing="0" border="0"><tr><td valign="top"><img src="/images/wireless-green.png" alt="" border="0"/></td><td valign="top"><img src="/images/clear.gif" width="1" height="5"/><br/>
                                <h:commandLink value="Change Your Password" action="#{changePassword.beginView}" styleClass="mediumfont" style="color: #596697;"/>
                            </td></tr>
                            <tr><td valign="top"></td><td valign="top">
                            ...
                            <br/><br/>
                            <table cellpadding="0" cellspacing="0" border="0"><tr><td valign="top"><img src="/images/wireless-green.png" alt="" border="0"/></td><td valign="top"><img src="/images/clear.gif" width="1" height="5"/><br/>
                                <h:commandLink value="Help/Support" action="#{accountSupportIssuesList.beginView}" styleClass="mediumfont" style="color: #596697;"/>
                            </td></tr>
                            <tr><td valign="top"></td><td valign="top">
                   ...
                   <%if (!Pagez.getUserSession().getUser().getPaymethodpaypaladdress().equals("")){%>
                        <div class="rounded" style="padding: 15px; margin: 5px; background: #e6e6e6;">
                            ...
                            <br/>
                            <font class="smallfont">Before we can pay you we must have a valid PayPal address.  Enter one: <img src="/images/clear.gif" width="2" height="1"/><h:commandLink action="#{accountSettings.beginView}">here</h:commandLink>.</font>
                        </div>
                   <%}%>
                </td>
                <td valign="top">
                    <table cellpadding="20" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td width="50%" align="left" valign="top">
                                <center><h:commandLink action="#{bloggerIndex.beginView}"><img src="/images/user.png" alt="" border="0" width="128" height="128"/></h:commandLink></center>
                                <div><d:greenRoundedButton pathtoapproot="../"><h:commandLink value="Bloggers" action="#{bloggerIndex.beginView}" styleClass="mediumfont" style="color: #ffffff;"/></d:greenRoundedButton></div>
                                <div style="padding: 10px;">
                                    ...
                                    <br/>
                                    <h:commandLink value="Continue as a Blogger" action="#{bloggerIndex.beginView}" styleClass="subnavfont" style="color: #596697;"/>
                                </div>
                            </td>
                            <td width="50%" align="left" valign="top">
                                <center><h:commandLink action="#{researcherIndex.beginView}"><img src="/images/statistic-128.png" alt="" border="0" width="128" height="128"/></h:commandLink></center>
                                <div><d:greenRoundedButton pathtoapproot="../"><h:commandLink value="Researchers" action="#{researcherIndex.beginView}" styleClass="mediumfont" style="color: #ffffff;"/></d:greenRoundedButton></div>
                                <div style="padding: 10px;">
                                    ...
                                    <br/>
                                    <h:commandLink value="Continue as a Researcher" action="#{researcherIndex.beginView}" styleClass="subnavfont" style="color: #596697;"/>
                                </div>
                            </td>
                        </tr>
                    </table>
