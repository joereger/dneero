...
<%@ include file="/template/header.jsp" %>
            ...
            <br/>When you start out with our business model you say "let's help researchers pay social people to join conversations and put them into their blogs."  Sounds simple enough.  But there are a lot of chances to do evil lurking in this core business model.
            ...
            <br/><br/>But if you're a blogger it just sucks.  You join one conversation and suddenly your data is flowing near and far into the hands of evil corporations.
