...
<%
CustomercarePanelsAddpeopleByPanelconfirm customercarePanelsAddpeopleconfirm= (CustomercarePanelsAddpeopleByPanelconfirm)Pagez.getBeanMgr().get("CustomercarePanelsAddpeopleByPanelconfirm");
%>
<%
            ...
            <tr>
             ...
             <tr>
                <td valign="top">
                    ...
                    <br/>
                    <a href="/customercare/panels-addpeople.jsp?respondentfilterid=<%=customercarePanelsAddpeopleconfirm.getRespondentfilterid()%>&panelid=<%=customercarePanelsAddpeopleconfirm.getPanelid()%>&panelidtoaddfrom=<%=customercarePanelsAddpeopleconfirm.getPanelidtoaddfrom()%>"><font class="tinyfont">Nevermind, Take me Back</font></a>
                </td>
                <td valign="top">
