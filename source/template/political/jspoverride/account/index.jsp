                       ...
                       <%}%>
                        ...
                        <div class="rounded" style="padding: 15px; margin: 5px; background: #e6e6e6;">
                            ...
                            <%if (Pagez.getUserSession().getIsCustomerCare()){ %>
                                <table cellpadding="0" cellspacing="0" border="0"><tr><td valign="top"><img src="/images/wireless-green.png" alt="" border="0"/></td><td valign="top"><img src="/images/clear.gif" width="1" height="5"/><br/>
                                    <a href="/customercare/index.jsp"><font class="mediumfont">Customer Care</font></a>
                                </td></tr>
                                <tr><td valign="top"></td><td valign="top">
                                    <font class="smallfont">Love the user!</font>
                                </td></tr></table>
                                <br/><br/>
                            <%} %>
                            ...
                            <br/><br/>
                            <table cellpadding="0" cellspacing="0" border="0"><tr><td valign="top"><img src="/images/wireless-green.png" alt="" border="0"/></td><td valign="top"><img src="/images/clear.gif" width="1" height="5"/><br/>
                                <a href="/blogger/bloggerdetails.jsp"><font class="mediumfont">Demographic Information</font></a>
                            </td></tr>
                            <tr><td valign="top"></td><td valign="top">
                                <font class="smallfont">Update your demographic information.</font>
                            </td></tr></table>
                            ...
                            <tr><td valign="top"></td><td valign="top">
                                <font class="smallfont">Use the Inbox messaging system to get help with your account.  Ask us anything.</font>
                            </td></tr></table>
                        </div>
                    </div>
                </td>
                                ...
                                <%--<div class="rounded" style="background: #e6e6e6; text-align:center; height: 75px;">--%>
                                    ...
                                    <%--<%if (Pagez.getUserSession().getUser().getBloggerid()>0){%>--%>
                                        ...
                                        <%--<%if (bloggerCompletedsurveys.getList()!=null && bloggerCompletedsurveys.getList().size()>0){%>--%>
                                            <%--<br/><a href="/blogger/index.jsp"><font class="smallfont" style="font-weight: bold;"><%=Pagez._Surveys()%> You've Joined</font></a>--%>
                                        <%--<%}%>--%>
                                    <%--<%}%>--%>
                                <%--</div>--%>
                            <%--</td>--%>
                                    ...
                                    <%--<div class="rounded" style="background: #e6e6e6; text-align:center; height: 75px;">--%>
                                        ...
                                        <%--<%if (Pagez.getUserSession().getUser().getResearcherid()>0){%>--%>
                                            ...
                                            <%--<%if (researcherSurveyList.getSurveys()!=null && researcherSurveyList.getSurveys().size()>0){%>--%>
                                                <%--<br/><a href="/researcher/index.jsp"><font class="smallfont" style="font-weight: bold;"><%=Pagez._Surveys()%> You've Created</font></a>--%>
                                            <%--<%}%>--%>
                                        <%--<%}%>--%>
                                    <%--</div>--%>
                                <%--<%}%>--%>
...
//                        "            </table>\n");
    ...
    "                    </div>");
                        ...
                        <%} else {%>
                            ...
                            %>
                            <%=Grid.render(bloggerCompletedsurveys.getList(), cols, 50, "/account/index.jsp", "pageyourconvos")%>
                        <%}%>
                    <%}%>
