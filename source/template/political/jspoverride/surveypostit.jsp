            ...
            <tr>
                ...
                <td valign="top" class="posttoblog_tabs_tablewidth">
                    ...
                    <div style="text-align:left; width: 400px;">
                        <!-- START GIGYA -->
                        <!-- http://wiki.gigya.com/055_Wildfire_API -->
                        <!-- http://wiki.gigya.com/055_Wildfire_API/055_API_reference/005_Configuration_Parameters -->
                        ...
                        var pconf={
                            ...
                            widgetTitle: 'MatterOfOpinion.com: <%=Str.cleanForGigyaWidget(publicSurveyPostit.getSurvey().getTitle())%>',
                            widgetDescription: '<%=Str.cleanForGigyaWidget(publicSurveyPostit.getSurvey().getDescription())%>',
                        ...
                        <!-- END GIGYA -->
                        <br/>
                        <a href="#" id="togglepagelink"><font class="tinyfont">Embed it Yourself (Advanced)</font></a>
                    </div>
                    </center>
                    ...
                    <br/><br/>
                    <font class="mediumfont">Manual Embed Code</font>
                    <br/>
                    <font class="smallfont">
                        <ol>
                            <li>Copy the code below. (Right-click and choose Copy or Left-click to select and hit Control-C)<br/>
                            ...
                            <li>Go to the page that allows you to create a blog entry, web page or other social media asset.</li>
